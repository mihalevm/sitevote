...
<div class="nav nav-tabs" id="profile-nav-btns" role="tablist">
  ...
  <button class="nav-link" id="statistics-btn-tab" data-bs-toggle="tab" data-bs-target="#statistics-tab" type="button" role="tab" aria-controls="" aria-selected="false">${statistics}</button></div>
</nav>
